      ...
      */
      ...
      function downloadFile (filename, header, data) {
        ...
        if ( filename !== false && (ua.indexOf("MSIE ") > 0 || !!ua.match(/Trident.*rv\:11\./)) ) {
          if ( window.navigator.ms<b>Save</b>OrOpenBlob ) {
            //noinspection JSUnresolvedFunction
            window.navigator.ms<b>Save</b>OrOpenBlob(new Blob([data]), filename);
          }
          else {
            ...
            if ( frame ) {
              ...
              frame.contentDocument.execCommand("<b>Save</b>As", true, filename);
